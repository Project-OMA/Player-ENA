...
namespace ENA.Character
{
    public static class LogBuilder
    {
        ...
        // public static void AddAction(YAMLBuilder yaml, Action action)
        // {
        ...
        // public static void AddCollision(YAMLBuilder yaml, Collision collision)
        // {
        ...
        // public static void AddObjective(YAMLBuilder yaml, Objective objective)
        // {
